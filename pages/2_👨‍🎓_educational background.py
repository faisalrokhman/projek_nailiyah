...
st.set_page_config(
    page_title="Riwayat Sekolah|Nailiyah",
    page_icon="👨‍🎓",
    layout="wide"
)
st.title("PENDIDIKAN YANG SAYA LALUI SEBAGAI BERIKUT;")
...
with st.container():
        col1, col2, col3, col4, = st.columns(4)
        with col1:
            st.caption("*Alamat : Jl. Cemara Gg. Kapling Rt. 05 Rw. 03, Sengon - Tanjung - Brebes*")
        with col2:
